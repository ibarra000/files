...
pub fn rows(viewer: ViewerKind) -> Vec<Row> {
    ...
    vec![
        ...
        Row::Entry("", "Whatever you point at is described beside the list,"),
        Row::Entry("", "or just under it on a narrower screen: how big it is,"),
        Row::Entry("", "when it last changed, which drive it is on, and how"),
        Row::Entry("", "many pages the code has. That is usually enough to"),
        Row::Entry("", "tell two similar names apart without opening either."),
        Row::Blank,
