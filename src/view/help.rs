...
pub fn rows(viewer: ViewerKind) -> Vec<Row> {
    ...
    vec![
        ...
        Row::Entry("Up Down", "move through the list"),
        Row::Entry("PgUp PgDn", "jump to the top or the bottom of it"),
        Row::Entry("", "The bottom left of the box says how many were found"),
        Row::Entry("", "and how many of them fit. Narrow the code to see the"),
        Row::Entry("", "rest."),
        ...
        Row::Entry("", "The bottom left of the box says which one is in use."),
        Row::Blank,
        ...
        Row::Entry("", "The line under the box says when the file list was"),
        Row::Entry("", "last updated, names any drive it cannot reach, and"),
        Row::Entry("", "says which one is worth updating."),
